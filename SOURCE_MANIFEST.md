...
## Build
- `index.html`, `styles.css`, `main.js`: original landing-page implementation.
...
- Publisher home used as a discovery link for the author bibliography: `https://nhanam.vn`.

## Supplied speaker portraits
